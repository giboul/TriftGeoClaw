...
def setrun(claw_pkg='geoclaw') -> ClawRunData:
    ...
    clawdata.lower[0] = mt.xmin  # west longitude
    clawdata.upper[0] = mt.xmax  # east longitude
    clawdata.lower[1] = mt.ymin  # south latitude
    clawdata.upper[1] = mt.ymax  # north latitude
    print(f"{clawdata.lower = }")
    print(f"{clawdata.upper = }")

    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = mt.n
    clawdata.num_cells[1] = mt.n
...
def setgeo(rundata: ClawRunData) -> ClawRunData:
    ...
    geo_data.sea_level = mt.sea_level
