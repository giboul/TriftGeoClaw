...
Cette méthode a l'avantage d'avoir une base physique (les équations de Saint-Venant) et d'être conservatrice car la dissipation énergétique liée à la transformation neige-eau est négligée.
L'énergie de la vague se limite en conséquence à celle transmise par l'avalanche et les vagues résultantes en sont d'autant plus réalistes.
