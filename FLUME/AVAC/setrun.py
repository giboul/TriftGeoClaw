...
#------------------------------
    ...
    clawdata.lower[0] = X.min()
    clawdata.upper[0] = X.max()
    clawdata.lower[1] = Y.min()
    clawdata.upper[1] = Y.max()
    ...
    clawdata.output_q_components = [1, 1, 1, 1] # 'all'   # could be list such as [True,True]
    ...
    amrdata.amr_levels_max = 1 + min(map(len, (amrdata.refinement_ratios_x, amrdata.refinement_ratios_y, amrdata.refinement_ratios_t))) -1
    ...
    clawdata.dt_initial = 0.01  # min_cell_size_x / 3.
    ...
    fgout.nx = int((clawdata.upper[0]-clawdata.lower[0]) * clawdata.num_cells[0]*np.prod(amrdata.refinement_ratios_x))
    fgout.ny = int((clawdata.upper[1]-clawdata.lower[1]) * clawdata.num_cells[1]*np.prod(amrdata.refinement_ratios_y))
    print(f"{fgout.nx, fgout.ny}")
    ...
    voellmydata.add_param("u_", 300, "Velocity threshold")
